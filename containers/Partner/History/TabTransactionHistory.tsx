...
import { PropsForAction, WrapperTable } from "components";
...
import { MERCHANTS_ITEM, MERCHANTS_WALLETS_ITEM } from "interfaces";
...
const ListingPartner = () => {
  ...
  const onViewHandler = useCallback((props: PropsForAction<MERCHANTS_WALLETS_ITEM>) => {
    const { row } = props;
  ...
  const onGotoHandler = useCallback((props: PropsForAction<MERCHANTS_ITEM>) => {
