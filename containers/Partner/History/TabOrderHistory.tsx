...
import { type PropsForAction, WrapperTable } from "components";
...
const TabOrderHistory = () => {
  ...
  const onViewHandler = useCallback((props: PropsForAction<MERCHANTS_STORES_ITEM>) => {
    const { row } = props;
  ...
  const onGotoHandler = useCallback((props: PropsForAction<MERCHANTS_STORES_ITEM>) => {
