...
const ListingTransaction = () => {
  ...
  const onViewHandler = useCallback((props: PropsForAction<CUSTOMERS_WALLETS_ITEM>) => {
    const { row } = props;
  ...
  const onGotoHandler = useCallback((props: PropsForAction<CUSTOMERS_WALLETS_ITEM>) => {
